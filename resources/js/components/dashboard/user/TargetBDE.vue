...
<v-content>
		<v-container fluid>
          ...
          <v-toolbar flat color="white">
            <v-toolbar-title>BDE List</v-toolbar-title>
          ...
          <v-data-table :headers="headers" :items="dataBDE">
              <template v-slot:item.status="{ item }">
                        <v-chip class="ma-2" color="primary" v-if="item.status==1" > Active </v-chip>
                         <v-chip class="ma-2" color="red" v-if="item.status !==1" > Disabled </v-chip>
              </template>
...
export default {
  ...
  data: () => ({
            ...
            try {
                ...
                targetList(item)
                    {
                        this.$router.push('/dashboard/user/targetbdelist/'+item.id);
                    },
                saleList(item)
                    {
                        this.$router.push('/dashboard/user/salebdelist/'+item.id);
                    },
              }
            };
</script>